...
%%%%
:- module(trace,[]).
/** <module> Keeping trace of node mutations during compositions
*/
...
%% push(+Trace, +Origin, +Destination, +Message, -Trace_p)
% Unify Trace_p with Trace, enhanced by a new peeble build from Origin to
...
%% multi_push(+Trace, +Origins, +Destination, +Message, -Trace_p)
...
%% as_picture(+Trace, +Format, +File_name)
