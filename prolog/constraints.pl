...
%% register_predicate/3: register_predicate(+Kind, +Action, +Predicate)
...
%% get_predicates/3: get_predicates(+Kind, +Action, -Predicates)
...
%% Check_conditions/3: check_conditions(+Kind, +Action, +Graph)
...
%% check_conditions_loop/4: check_conditions_loop(+Preds, +Graph, +Action, +Err)
